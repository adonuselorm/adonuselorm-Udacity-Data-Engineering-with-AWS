...
CustomerTrusted_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-lake-house-selormadonu/customer/trusted/"],
        "recurse": True,
    },
...
AccelerometerTrusted_node1690329778730 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-lake-house-selormadonu/accelerometer/trusted/"],
        "recurse": True,
    },
...
CustomerCurated_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://stedi-lake-house-selormadonu/customer/curated/",
        "partitionKeys": [],
    },
